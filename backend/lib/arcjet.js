...
export const aj = arcjet({
  ...
  rules: [
    ...
    tokenBucket({
      mode: "LIVE",
      refillRate: 10, //number of tokens to add per interval (5 every 10 seconds = 30 per minute with a max of 10 at any time)
      interval: 5, //interval in seconds
      capacity: 30, //max number of tokens in the bucket
    }),
  ],
});
